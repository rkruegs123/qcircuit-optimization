...
def lc_cong(g, v):
    # get adjacent for v
    # get neighbors of v
    # get adjacents of all neighbor? Can none of them have more than 1 IO? Do we have to preserve graph-like-ness?
    raise NotImplementedError("TODO: [lc_cong]")




###### FIXME: The following doesn't belong in this file
...
def pivot_anneal(g, iters=1000, temp=5, cool=0.005, score=None):
    g = g.copy()
